  ...
  return (
    <div className="projects-tab">
      <p className="settings-description">
        Register project directories to enable per-project configuration and sync.
      </p>
      <button
        type="button"
      ...
      {projects.length === 0 && (
        <p className="project-directories-empty">No project directories registered yet.</p>
      )}
