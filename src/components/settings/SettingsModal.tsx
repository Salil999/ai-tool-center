...
export function SettingsModal({
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      onSuccess?.('All configs have been reset.');
      onReset?.();
      onClose();
    } catch (err) {
      onError?.((err as Error).message);
    ...
    <div className="modal settings-modal">
      ...
      <div className="modal-body settings-modal-body">
        ...
        <section className="settings-section">
          <h3>Import</h3>
          <p className="settings-description">
            Import configs from a previous export. Merges with existing data.
          </p>
          <input
            ref={fileInputRef}
            type="file"
        ...
        <section className="settings-section">
          <h3>Reset</h3>
          <p className="settings-description">
            Permanently delete all configs, credentials, skills, and audit log.
          </p>
          {showResetConfirm ? (
