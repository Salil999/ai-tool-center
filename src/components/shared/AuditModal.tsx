...
const ACTION_LABELS: Record<string, string> = {
  ...
  agent_sync_to_provider: 'AGENTS.md synced to provider',
  agent_sync_to_project: 'AGENTS.md synced to project',
  rule_import_source: 'Rules imported from source',
  rule_import_custom: 'Rules imported from custom path',
  rule_import_project_provider: 'Rules imported from project to provider',
  rule_import_project_agent: 'Rules imported from project to AGENTS.md',
  ...
  agent_import_project: 'AGENTS.md imported from project',
  agent_import_source: 'AGENTS.md imported from source',
  agent_import_custom: 'AGENTS.md imported from custom path',
  ...
  project_directory_reorder: 'Project directories reordered',
