...
import { getSubagentSyncTargets } from '../../api-client';
...
interface SubagentSyncSectionProps {
  onSyncToProvider: (targetId: string) => void;
  onSyncToProject: (targetId: string) => void;
}

export function SubagentSyncSection({ onSyncToProvider, onSyncToProject }: SubagentSyncSectionProps) {
  ...
  const fetchTargets = useCallback(() => {
    getSubagentSyncTargets().then(setTargets).catch(() => {});
  }, []);
